# Docker Setup Guide - AFZN Studio Toon

Panduan untuk menjalankan aplikasi AFZN Studio Toon menggunakan Docker.
...
1. **Frontend** (web) - React/Vite app dengan Nginx
   - Port: 8072
   - Container: afzn-studio-toon-frontend

2. **Backend** (backend) - Hono API Server dengan SQLite
   - Port: 8062
   - Container: afzn-studio-toon-backend
...
```bash
# Backend shell
docker exec -it afzn-studio-toon-backend sh

# Frontend shell
docker exec -it afzn-studio-toon-frontend sh
```
...
docker cp afzn-studio-toon-backend:/app/server/statistics.db ./backup-statistics.db
...
docker cp ./backup-statistics.db afzn-studio-toon-backend:/app/server/statistics.db
...
docker stats afzn-studio-toon-backend afzn-studio-toon-frontend

# View detailed info
docker inspect afzn-studio-toon-backend
```
