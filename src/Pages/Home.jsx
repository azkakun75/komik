...
const Home = () => {
  return (
    <>
      <SEO
        title="AFZN Studio Toon - Baca Komik Gratis Bahasa Indonesia Terbaru"
        description="Baca komik online gratis di AFZN Studio Toon. Koleksi lengkap komik terbaru, trending, dan populer dalam bahasa Indonesia. Update setiap hari!"
        keywords="komik indonesia, baca komik gratis, komik online, manga indonesia, manhwa indonesia"
        url="https://afzn-studio-toon.vercel.app/"
      />
            ...
            <div className="border-t border-gray-300 dark:border-gray-700 pt-8">
              <div className="text-center">
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  AFZNStudio - Platform baca komik online terbaik
                </p>
                <p className="text-gray-500 dark:text-gray-500 text-xs mt-2">
                  &copy; 2024 AFZNStudio. All rights reserved.
                </p>
              </div>
            </div>
          </div>
