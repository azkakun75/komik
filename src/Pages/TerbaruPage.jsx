...
const TerbaruPage = () => {
    return (
        <>
            <SEO
                title="Komik Terbaru"
                description="Daftar komik terbaru yang baru saja update. Baca komik online gratis dengan update terbaru setiap hari di AFZN Studio Toon."
                keywords="komik terbaru, komik baru, update komik, komik hari ini"
                url="https://afzn-studio-toon.vercel.app/terbaru"
            />
