    ...
    return (
        <>
            <SEO
                ...
                description="Komik paling populer dan trending saat ini. Temukan komik favorit yang paling banyak dibaca di AFZN Studio Toon."
                keywords="komik trending, komik populer, komik hits, komik viral"
                url="https://afzn-studio-toon.vercel.app/trending"
            />
