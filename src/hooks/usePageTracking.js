...
export const usePageTracking = () => {
  ...
  useEffect(() => {
    // Stats backend is optional. When VITE_API_URL is not configured we
    // simply skip tracking instead of pinging the frontend's own host with
    // a 404 on every navigation.
